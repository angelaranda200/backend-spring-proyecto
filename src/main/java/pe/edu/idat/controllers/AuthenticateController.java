...
import pe.edu.idat.auth.JwtRequest;
import pe.edu.idat.auth.JwtResponse;
import pe.edu.idat.auth.JwtUtils;
...
public class AuthenticateController {
	...
	public Usuarios usuarioCurrente(Principal principal) {
		return (Usuarios) this.userDetailsServiceImpl.loadUserByUsername(principal.getName());
	}
